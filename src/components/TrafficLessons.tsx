...
const LIGHTS_QUIZ: QuizQuestion[] = [
  ...
  },
  {
    id: 'light-q4',
    section: 'Світлофори',
    question: 'На трамвайному Т-подібному світлофорі горять три верхні біло-місячні сигнали, а нижній вимкнений. Чи можна рухатися?',
    options: [
      'Так — верхні сигнали дозволяють рух',
      'Ні — без нижнього сигналу рух заборонено',
      'Так, але лише прямо',
    ],
    correctIndex: 1,
    explanation:
      'Нижній біло-місячний сигнал обов\'язковий для початку руху. Три верхні без нижнього — рух заборонено (п. 8.7.5 ПДР).',
  },
];
